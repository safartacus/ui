      ...
      <form [formGroup]="productForm" (ngSubmit)="onSubmit()" class="product-form">
        ...
        <div class="form-group">
          ...
          <div class="contact-info">
            <p>İletişim bilgileriniz profil sayfanızdan alınacaktır.</p>
            <a routerLink="/user/profile">Profil Bilgilerini Güncelle</a>
          </div>
        </div>
  ...
  onSubmit() {
    if (this.productForm.valid) {
      ...
      setTimeout(() => {
        ...
        // TODO: Navigate to product detail page after successful creation
      }, 2000);
    }
  }
}
